...
class WeatherWorld extends Node {
  WeatherWorld() {
    size = const Size(2048.0, 2048.0);
...
class GradientNode extends Node {
  GradientNode(Size size, this.colorTop, this.colorBottom) {
    this.size = size;
  }
...
class CloudLayer extends Node {
  ...
  Sprite _createSprite(ui.Image image, bool dark, bool rotated) {
    ...
    sprite.relativePositionAnchor = Sprite.centerOffset;
    sprite.rotationPivot = Sprite.centerOffset;
    sprite.scalePivot = Sprite.centerOffset;
...
class Sun extends Node {
  Sun() {
    ...
    _sun.relativePositionAnchor = Sprite.centerOffset;
    _sun.scalePivot = _sun.rotationPivot = Sprite.centerOffset;
    _sun.scale = 4.0;
...
class Ray extends Sprite {
  ...
  Ray() : super.fromImage(_images['assets/ray.png']!) {
    relativePositionAnchor = const Offset(0.0, 0.5);
