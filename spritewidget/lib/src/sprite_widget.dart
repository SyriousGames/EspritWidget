...
class SpriteWidget extends SingleChildRenderObjectWidget {
  ...
  ///
  /// The most common way to setup the sprite node graph is to subclass [Node] and pass it to the sprite widget.
  /// In the custom subclass it's possible to build the node graph, do animations and handle user events.
  ///
  ///     var mySpriteTree =  MyCustomNode();
  ///     var mySpriteWidget =  SpriteWidget(mySpriteTree, SpriteBoxTransformMode.fixedHeight);
