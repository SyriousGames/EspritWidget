...
class ConstraintRotationToMovement extends Constraint {
  ...
  ConstraintRotationToMovement({this.baseRotation = 0.0, this.dampening = 0.0});
...
class ConstraintRotationToNodeRotation extends Constraint {
  ...
  ConstraintRotationToNodeRotation(this.targetNode,
      {this.baseRotation = 0.0, this.dampening = 0.0});
...
class ConstraintPositionToNode extends Constraint {
  ...
  ConstraintPositionToNode(this.targetNode,
      {this.dampening = 0.0, this.offset = Offset.zero});
...
/// A [Constraint] which dynamically calculates its constraints.
class FunctionalConstraint extends Constraint {
  FunctionalConstraint(this.fn);

  final void Function(Node node, double dt) fn;
